/*
    ...
    NOTE: Largest Array Length java can handle with 4gb heap space should be 1,073,741,824 elements since for int[]
...
public class MaxArrayLength {
    public static void main(String[] args) {
        ...
        try {
            // See NOTE above on to why I chose this size array
        ...
        {
            // Java JVM is NOT at least using 4gb of heap space
            System.out.println("Failed to create the array. Error Message: " + e.getMessage());
            System.out.println("Make sure to have allocated at least 4gb of JVM heap space...");
        }
